...
import br.zul.zwork4.exception.ZHttpRequestException;
...
class ZHttpRequestSender {
    ...
    //MÉTODOS PÚBLICOS
    //==========================================================================
    public ZHttpResponse send() throws ZHttpRequestException, ZHttpResponseException {
    ...
    //MÉTODOS PRIVADOS
    //==========================================================================
    private ZUrl buildUrl() throws ZHttpRequestException{
    ...
    private ZUrl buildUrlWithParams() {
    ...
    private ZHttpResponse buildResponse(HttpURLConnection connection, ZUrl url) {
    ...
    private HttpURLConnection buildConnection(ZUrl url) throws IOException, NoSuchAlgorithmException, KeyManagementException {
    ...
    private HttpURLConnection initConnection(ZUrl url) throws IOException {
    ...
    private void treatHttpsConnection(HttpURLConnection connection, ZUrl url) throws NoSuchAlgorithmException, KeyManagementException {
    ...
    private void prepareAutoDownloadCertificates(HttpsURLConnection connection, ZUrl url) {
    ...
    private ZHttpResponse sendRequestTo(ZUrl url, Consumer<HttpURLConnection> connectionConsumer){
        try {
    ...
    private ZHttpResponse followRedirect(ZUrl url, ZHttpResponse response) throws IOException, NoSuchAlgorithmException, KeyManagementException {
